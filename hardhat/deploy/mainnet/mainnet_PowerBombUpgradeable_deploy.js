...
module.exports = async ({ deployments }) => {
  ...
  console.log("Now deploying PowerBombUpgradeable on Mainnet...");
  ...
  console.log("Now deploying PowerBombUpgradeableProxy for BTC on Mainnet...");
  ...
  console.log("Now deploying PowerBombUpgradeableProxy for ETH on Mainnet...");
...
module.exports.tags = ["mainnet_PowerBombUpgradeable_deploy"];
